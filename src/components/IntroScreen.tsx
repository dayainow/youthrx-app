  ...
  return (
    <div className="p-6 sm:p-8 md:p-12 flex-1 flex flex-col items-center justify-center gap-8 sm:gap-10 md:grid md:grid-cols-[1.08fr_0.92fr] md:grid-rows-[1fr_auto] md:gap-x-10 md:gap-y-8 animate-fade-in relative z-20">
      ...
      <div className="relative w-40 h-40 md:w-56 md:h-56 flex items-center justify-center md:justify-self-center">
         <div className="absolute inset-0 bg-[#E8D9C0] rounded-full animate-pulse-slow opacity-50 blur-xl"></div>
         <div className="w-32 h-32 md:w-44 md:h-44 rounded-full flex items-center justify-center bg-[#FFFDF9] shadow-[0_16px_40px_rgba(139,69,19,0.16)] relative z-10 border border-[#E8E1D5]">
      ...
      <button 
        onClick={onNext} 
        className="w-full md:col-span-2 md:max-w-[520px] md:justify-self-center bg-[#3E3A39] hover:bg-[#2C2928] text-white font-semibold py-4 sm:py-5 px-6 rounded-[1.25rem] transition-all flex items-center justify-center space-x-2 z-10 shadow-[0_10px_20px_rgba(62,58,57,0.18)] active:scale-[0.98]"
      >
